...
<div class="container p-5 mt-5 bg-dark">
    <div class="row">
        <div class="col-lg-5">
            <div>
                <img src="images/bac.jpg" alt="Login" width="400" height="300">
            </div>
        </div>
        <div class="col-lg-7">
            ...
            <form action="handle_login.php" method="post">
                ...
                <div class="row mb-3">
                    <input type="submit" name="login" class= "rounded-pill btn btn-warning" value="Login">
                </div>
                <hr>
                <div class="row mb-3">
            ...
            <div class="text-center">
                <a class="small" href="account.php">Create an Account</a>
            </div>
        </div>
    </div>
</div>
